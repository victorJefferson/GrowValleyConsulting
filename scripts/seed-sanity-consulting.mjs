...
tx.createOrReplace({
  ...
  title: "GrowValley Consulting Settings",
  ...
  footerCopyright: "© 2026 GrowValley Consulting | A subsidiary of GrowValley Group.",
});
...
tx.createOrReplace({
  ...
  introParagraph:
    "GrowValley Consulting integrates growth, capital, and innovation decisions with disciplined execution and governance.",
  ...
  narrativeSections: [
    {
      ...
      body: "GrowValley Consulting is the strategy and advisory arm of the GrowValley ecosystem.",
    },
    {
      _key: "a2",
...
for (const key of partnerKeys) {
  tx.createOrReplace({
    ...
    heroSubheadline:
      "GrowValley Consulting partners with experts, operators, platforms, and ecosystem builders.",
    heroCtaLabel: "Talk to Our Advisor",
    heroCtaLink: "/contact",
    ...(key === "landing"
      ? {
          whyHeadline: "Why Partner With GrowValley Consulting",
          whyBody:

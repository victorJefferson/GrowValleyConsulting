...
export const metadata: Metadata = {
    title: {
        absolute: "Insights | GrowValley Consulting"
    },
    description:
        "Perspectives on strategy, capital, innovation, and execution from the GrowValley Consulting team.",
    openGraph: {
        title: "Insights | GrowValley Consulting",
        description:
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "GrowValley Consulting Insights",
            },
        ],
    },
};

...
export const metadata: Metadata = {
    title: { absolute: "Our Top Expertise | GrowValley Consulting" },
    description:
        "Advisory. Execution. Accountability. GrowValley Consulting partners with organisations at critical moments of inflection.",
    openGraph: {
        title: "Our Top Expertise | GrowValley Consulting",
        description:
                    ...
                    <div className="container">
                        ...
                        {(pageData?.howWeEngageClosing?.trim() || pageData?.howWeEngageCtaLabel) && (
                            <div className={styles.howWeEngageCtaWrap}>
                                <CtaBanner
                                    headline="Start a strategic conversation with GrowValley Consulting."

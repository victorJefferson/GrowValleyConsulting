...
export const metadata: Metadata = {
    title: {
        absolute: "Our Capabilities | GrowValley Consulting",
    },
    description:
    ...
    openGraph: {
        title: "Our Capabilities | GrowValley Consulting",
        description:
            "Explore GrowValley Consulting's integrated advisory capabilities.",

...
export const metadata: Metadata = {
    title: {
        absolute: "Privacy Policy | GrowValley Consulting"
    },
    description: "GrowValley Consulting is committed to protecting the privacy and security of your personal data. Read our privacy policy.",
    openGraph: {
        title: "Privacy Policy | GrowValley Consulting",
        description: "GrowValley Consulting's commitment to data privacy and security.",
...
export default async function PrivacyPolicyPage() {
    ...
    const defaultContent = (
        <div className={styles.legalContent}>
            ...
            <p>GrowValley Consulting is committed to protecting the privacy and security of your personal data. This policy outlines how we collect, use, and safeguard information provided by visitors to our website.</p>

...
export const metadata: Metadata = {
    title: { absolute: "Partner With Us | GrowValley Consulting" },
    description:
        "Expertise. Reach. Execution. GrowValley Consulting partners with experts, operators, platforms, and ecosystem builders.",
    openGraph: {
        title: "Partner With Us | GrowValley Consulting",
        description:
                ...
                subheadline={
                    <>
                        ...
                        {pageData?.heroSubheadline ?? heroData?.subheadline ??
                            "GrowValley Consulting partners with experts, operators, platforms, and ecosystem builders who share a commitment to execution-led growth and long-term value creation."}
                    </>
                }
                image={heroImage}
                hasCTA
                ...
                <div className="container">
                    <div className={styles.whySplit}>
                        <figure className={styles.whyVisual}>
                            <img
                                src={whySectionImage}
                                alt={pageData?.whyHeadline ?? "Why partner with GrowValley Consulting"}
                                loading="lazy"
                                decoding="async"
                            />
                        </figure>
                        <div className={styles.whyContent}>
                            <h2>{pageData?.whyHeadline ?? "Why Partner With GrowValley Consulting"}</h2>
                            {pageData?.whyBody ? (
                    ...
                    <div className={styles.closing}>
                        ...
                        <p>
                            {pageData?.closingBody ??
                                "GrowValley Consulting is not looking for vendors or sponsors. We are looking for collaborators who bring real capability, operate with discipline, and are committed to outcomes over appearances. If that describes how you work, we should talk."}
                        </p>

...
export const metadata: Metadata = {
  title: {
    absolute: "Our Team | GrowValley Consulting",
  },
  description:
    "Meet the GrowValley Consulting team — senior advisors with deep operating experience across strategy, capital, and execution.",
  openGraph: {
    title: "Our Team | GrowValley Consulting",
    description: "GrowValley Consulting advisory team.",

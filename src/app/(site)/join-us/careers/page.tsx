...
export const metadata: Metadata = {
  title: { absolute: "Careers | GrowValley Consulting" },
  description:
    "Solve hard problems. Build real systems. Work that matters. Join the GrowValley Consulting team at the intersection of strategy, capital, and execution.",
  openGraph: {
    title: "Careers | GrowValley Consulting",
    description: "Explore career opportunities at GrowValley Consulting.",

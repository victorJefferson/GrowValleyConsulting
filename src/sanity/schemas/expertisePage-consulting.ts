...
export default defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            type: "text",
            rows: 3,
            initialValue: "GrowValley Consulting partners with organisations at critical moments of inflection — when growth is being pursued, capital decisions carry weight, and execution discipline becomes essential.",
        }),
        defineField({
            name: "heroImage",
            title: "Hero: Image",
        ...
        defineField({
            ...
            type: "string",
            initialValue: "The GrowValley Consulting Difference",
        }),
        defineField({

...
export default defineConfig({
  ...
  schema: {
    ...
    templates: (prev) => [
      ...
      {
        id: 'hero-pmo-consulting',
        title: 'Hero (PMO - Consulting)',
        schemaType: 'hero-consulting',
        value: {
          pageSlug: 'pmo',
          hasCTA: true,
          ...
          subheadline: 'Visibility. Accountability. Delivery. We design and operate enterprise-grade PMOs that give leadership teams full visibility into delivery performance, resource accountability, and program risk.',
          ctaText: 'Talk to Our Advisor',
          ctaHref: '/contact',
        },
      },
      {
        ...
        title: 'Hero (Family Office Setup - Consulting)',
        schemaType: 'hero-consulting',
        value: {
